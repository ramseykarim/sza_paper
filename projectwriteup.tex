...
\abstract{
	...
	We find ammonia to be present at over half the nominal value below the $P\sim 0.8$ bar NH$_{3}$ cloud layer specified in \citealt{}, corresponding to a new deep ($P \sim 8$ bar) atmosphere fractional abundance of $2.4\e{-4}$.
...
\section{Data} \label{s:data}
	...
	The SZA is a set of eight 3.5 m elements sensitive to left circularly polarized radiation in a compact array (REFERENCE KARTO FOR ARRAY CONFIG)
...
\subsubsection{Synchrotron Correction}
	...
	A survey of that spectrum from 74 MHz up to 8 GHz, described in de Pater et al. 2003, suggests that synchrotron contribution to the planet's radio spectrum drops off above 2 GHz, so we believe that, with frequencies around 30 GHz, our measurements contain negligible synchrotron-induced variability.
