...
\abstract{
	...
	We find ammonia to be present at over half the nominal [WHICH NOMINAL] value below the $P\sim 0.8$ bar NH$_{3}$ cloud layer, corresponding to a new deep ($P \sim 8$ bar) atmosphere fractional abundance of $2.4\e{-4}$.
