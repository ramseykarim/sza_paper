...
\maketitle
\abstract{
	We present a new set of CARMA measurements of Jupiter's thermal emission in the microwave, near the 1.3 cm ammonia (NH$_{3}$) absorption band, which we use to investigate ammonia abundance in the upper troposphere, near $0.3<P<2$ bar, based on radiative transfer modeling.
	We find ammonia to be present at over half the nominal value below the $P\sim 0.8$ bar NH$_{3}$ cloud layer, corresponding to a new deep ($P \sim 8$ bar) atmosphere fractional abundance of $2.4\e{-4}$.
